...
def generate_1d_contrastive_data(num_training_points, observation_noise_variance):
  ...
  ### Background data
  index_points_bg = np.random.uniform(-2., 2., (num_training_points, 1))
  ...
  ### Foreground data
  index_points_fg1 = np.random.uniform(-2., 2., (num_training_points//2, 1))
  ...
  index_points_fg2 = np.random.uniform(-2., 2., (num_training_points//2, 1))
